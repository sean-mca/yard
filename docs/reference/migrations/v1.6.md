...
See [configuration reference](../configuration.md#dagyaml-trigger-block) for the full `trigger:` block reference, and airflow DAG reference for backfill caveats per source.
...
See [configuration reference](../configuration.md) for the full v1.6 `dag.yaml` reference, airflow DAG reference for runtime semantics, and the [v1.6 ROADMAP entry](../../../.planning/ROADMAP.md) for the milestone scope.
